...
namespace Lab7_Entity_Framework
{
    public partial class MainForm : Form
    {
        ...
        private void btnRealoadFood_Click(object sender, EventArgs e)
        {
        ...
        {
            // Nếu không có món ăn nào được chọn thì không cần làm gì cả
            ...
            // Truy vấn để lấy thông tin món ăn được chọn
